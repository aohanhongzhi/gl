...
var (
	...
	gpVDPAURegisterVideoSurfaceWithPictureStructureNV        uintptr
...
func VDPAURegisterVideoSurfaceWithPictureStructureNV(vdpSurface unsafe.Pointer, target uint32, numTextureNames int32, textureNames *uint32, isFrameStructure bool) uintptr {
	ret, _, _ := syscall.Syscall6(gpVDPAURegisterVideoSurfaceWithPictureStructureNV, 5, uintptr(vdpSurface), uintptr(target), uintptr(numTextureNames), uintptr(unsafe.Pointer(textureNames)), boolToUintptr(isFrameStructure), 0)
	return (uintptr)(ret)
}
...
func InitWithProcAddrFunc(getProcAddr func(name string) unsafe.Pointer) error {
	...
	gpVDPAURegisterVideoSurfaceWithPictureStructureNV = uintptr(getProcAddr("glVDPAURegisterVideoSurfaceWithPictureStructureNV"))
