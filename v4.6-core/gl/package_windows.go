...
func InitWithProcAddrFunc(getProcAddr func(name string) unsafe.Pointer) error {
	...
	if gpCheckNamedFramebufferStatus == 0 {
	...
	if gpClearNamedBufferSubData == 0 {
	...
	if gpCompressedTextureSubImage1D == 0 {
	...
	if gpCompressedTextureSubImage2D == 0 {
	...
	if gpCompressedTextureSubImage3D == 0 {
	...
	if gpDisableVertexArrayAttrib == 0 {
	...
	if gpEnableVertexArrayAttrib == 0 {
	...
	if gpFlushMappedNamedBufferRange == 0 {
	...
	if gpGetCompressedTextureImage == 0 {
	...
	if gpGetCompressedTextureSubImage == 0 {
	...
	if gpGetNamedBufferParameteri64v == 0 {
	...
	if gpGetNamedBufferParameteriv == 0 {
	...
	if gpGetNamedFramebufferAttachmentParameteriv == 0 {
	...
	if gpGetNamedFramebufferParameteriv == 0 {
	...
	if gpGetNamedRenderbufferParameteriv == 0 {
	...
	if gpGetTextureLevelParameterfv == 0 {
	...
	if gpGetTextureLevelParameteriv == 0 {
	...
	if gpGetTextureParameterIuiv == 0 {
	...
	if gpInvalidateNamedFramebufferData == 0 {
	...
	if gpInvalidateNamedFramebufferSubData == 0 {
	...
	if gpMultiDrawArraysIndirectCount == 0 {
		return errors.New("glMultiDrawArraysIndirectCount")
	}
	...
	if gpMultiDrawElementsIndirectCount == 0 {
		return errors.New("glMultiDrawElementsIndirectCount")
	}
	...
	if gpNamedFramebufferDrawBuffer == 0 {
	...
	if gpNamedFramebufferDrawBuffers == 0 {
	...
	if gpNamedFramebufferParameteri == 0 {
	...
	if gpNamedFramebufferReadBuffer == 0 {
	...
	if gpNamedFramebufferRenderbuffer == 0 {
	...
	if gpNamedFramebufferTexture == 0 {
	...
	if gpNamedFramebufferTextureLayer == 0 {
	...
	if gpNamedRenderbufferStorage == 0 {
	...
	if gpNamedRenderbufferStorageMultisample == 0 {
	...
	if gpPolygonOffsetClamp == 0 {
		return errors.New("glPolygonOffsetClamp")
	}
	...
	if gpSpecializeShader == 0 {
		return errors.New("glSpecializeShader")
	}
	...
	if gpTextureStorage2DMultisample == 0 {
	...
	if gpTextureStorage3DMultisample == 0 {
	...
	if gpTransformFeedbackBufferBase == 0 {
	...
	if gpTransformFeedbackBufferRange == 0 {
	...
	if gpVertexArrayBindingDivisor == 0 {
	...
	if gpVertexArrayElementBuffer == 0 {
